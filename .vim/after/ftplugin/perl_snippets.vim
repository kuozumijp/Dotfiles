...
exec "Snippet perl \#!/usr/local/bin/perl<CR>\#\#\#<CR>\# ".st."Title".et."<CR>\#<CR>\# \@author ".AUTHOR." <".MAILADDRESS."><CR>\# \@since ".TODAY."<CR>\# @copyright Copyright (C) ".COPYRIGHT.". All Rights Reserved.<CR>\#\#\#<CR><CR>".st.et
