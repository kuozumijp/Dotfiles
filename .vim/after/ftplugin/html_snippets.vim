...
exec "Snippet html <html><CR>".st.et."</html>"
exec "Snippet head <head><CR><meta http-equiv=\"Content-type\" content=\"text/html; charset=euc-jp\" /><CR><title>".st.et."</title><CR>".st.et."<CR></head><CR>".st.et
exec "Snippet script <script type=\"text/javascript\" language=\"javascript\" charset=\"euc-jp\"><CR>// <![CDATA[<CR><TAB>".st.et."<CR>// ]]><CR></script><CR>".st.et
