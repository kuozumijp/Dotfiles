...
exec "Snippet sh #!/bin/sh<CR><CR>#<CR># ".st."Title".et."<CR>#<CR># @version $Id$<CR>#<CR># @author ".AUTHOR." <".MAILADDRESS."><CR># @since ".st."YYYY".et."/".st."MM".et."/".st."DD".et."<CR># @copyright Copyright (C) ".COPYRIGHT.". All Rights Reserved.<CR>#<CR>".st.et
