...
exec "Snippet sh #!/bin/sh<CR><CR>#<CR># ".st."Title".et."<CR>#<CR># @author ".AUTHOR." <".MAILADDRESS."><CR># @since ".TODAY."<CR># @copyright Copyright (C) ".COPYRIGHT.". All Rights Reserved.<CR>#<CR>".st.et
